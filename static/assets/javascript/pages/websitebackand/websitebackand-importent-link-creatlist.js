    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const search_url = "/importent-link-api/?title=" + title + "&link=" + link +"&status" +status;
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/websitebackend-importent-link-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
    ...
    function delete_customer(id) {
        $.ajax({
            url: '/websitebackend-importent-link-delete/' + id,
            type: 'POST',
            dataType: 'json',
            success: function (data) {

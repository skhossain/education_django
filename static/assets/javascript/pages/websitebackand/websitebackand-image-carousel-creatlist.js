    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                console.log('test')
                var title1 = document.getElementById('id_title1').value;
                var title2 = document.getElementById('id_title2').value;
                var image = document.getElementById('id_image').value;
                var status = document.getElementById('id_status').value;
                var button_lavel = document.getElementById('id_button_lavel').value;
                var button_url = document.getElementById('id_button_url').value;

                const search_url = "/apiwebsite-imagecarousel-api/?title1=" + title1 + "&title2=" + title2+ "&image" +image +"&status" +status+"&button_lavel" +button_lavel+"&button_url" +button_url;
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/websitebackend-image-carousel-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
    ...
    function delete_customer(id) {
        $.ajax({
            url: '/websitebackend-image-carousel-delete/' + id,
            type: 'POST',
            dataType: 'json',
            success: function (data) {

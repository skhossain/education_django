    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const search_url = "/apiwebsite-navbarmenu-api/?menu_lavel=" + menu_lavel + "&menu_url=" + menu_url+ "&serial" +serial +"&status" +status;
...
$(function () {
    ...
    $('#dt-table-list').on('click', 'button', function () {
        ...
        if (class_name == 'btn btn-warning btn-sm') {
            if (confirm('Are you sure you want to remove this Navbar?') == true) {
                delete_customer(id)
            }
        }
    })
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/websitebackend-navbar-menu-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
    ...
    function delete_customer(id) {
        $.ajax({
            url: '/websitebackend-navbar-menu-delete/' + id,
            type: 'POST',
            dataType: 'json',
            success: function (data) {

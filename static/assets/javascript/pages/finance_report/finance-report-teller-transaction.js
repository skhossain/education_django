...
function save_and_show_report() {
	...
	var report_data = {
		'p_branch_code': $('#id_branch_code').val(), 'p_teller_id': $('#id_teller_id').val(),
...
$(document).ready(function() {
    $('#id_teller_id').select2({placeholder: " Select a Teller "});
});
    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apisms-template-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'message_type' },
                        { data: 'message_label' },
                        { data: 'minimum_tran_amount' },
                        { data: 'is_messaging_enable' },
                        {
                            "data": null,
...
$(document).ready(function () {
    $('#id_template_type').select2();
    $('#id_message_type').select2();
    $('#id_message_label').select2();
});

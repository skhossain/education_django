    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apihostel-meal-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        { data: 'meal_type_id.meal_type_name' },
                        { data: 'meal_name' },
                        { data: 'meal_price' },
                        {
                            "data": null,
...
$('#btnSearch').click(
    ...
    function () {
        const meal_name = document.getElementById('id_meal_name').value;
        //if (branch_code === "") {
...
// Select 2
$('#id_meal_type_id').select2({placeholder: "Select a meal type"})
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_meal_type_id').val('').trigger('change')
            } else {
                $('#page_loading').modal('hide');

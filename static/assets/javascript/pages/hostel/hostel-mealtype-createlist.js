    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apihostel-mealtype-api/";
...
$('#btnSearch').click(
    ...
    function () {
        const meal_type_name = document.getElementById('id_meal_type_name').value;
        //if (branch_code === "") {

    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const room_name_or_number = document.getElementById('id_room_name_or_number').value;
                const search_url = "/apihostel-roommanagement-api/?room_name_or_number="+room_name_or_number;
...
$(function () {
    ...
    $('#dt-table-list').on('click', 'button', function () {
        ...
        try {
            ...
            id = table_row['rooms_management_id']
        }
        catch (e) {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/hostel-roommanagement-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {

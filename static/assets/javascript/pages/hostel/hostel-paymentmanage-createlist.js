    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const search_url = "/apihostel-paymentmanage-api/?academic_year="+academic_year;
...
$('#btnSearch').click(
    ...
    function () {
        const id_academic_year = document.getElementById('id_academic_year').value;
        //if (branch_code === "") {
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/hostel-paymentmanage-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
...
$('#id_pay_for_id').select2({placeholder: "Select a payfor name"})

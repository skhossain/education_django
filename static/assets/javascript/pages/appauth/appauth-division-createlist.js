    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apiauth-division-api/";
...
// Select 2
$('#id_country_id').select2({placeholder: "Select a country name"})
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_country_id').val('').trigger('change')
            } else {
                $('#page_loading').modal('hide');

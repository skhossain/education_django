    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apiauth-district-api/";
...
// Select 2
$('#id_division_id').select2({placeholder: "Select a division name"})
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_division_id').val('').trigger('change')
            } else {
                $('#page_loading').modal('hide');

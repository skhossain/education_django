    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const upozila_id=""
                const search_url = "apiauth-upazila-api/";
...
// Select 2
$('#id_district_id').select2({placeholder: "Select a district name"})
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_district_id').val('').trigger('change')
            } else {
                $('#page_loading').modal('hide');

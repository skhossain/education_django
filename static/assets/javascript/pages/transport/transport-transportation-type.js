    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apitransport-transportationtype-api/";
...
$(function () {
    ...
    $('#dt-table-list').on('click', 'button', function () {
        ...
        try {
            ...
            id = table_row['transportation_type_id']
        }
        catch (e) {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/transport-transportationtype-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {

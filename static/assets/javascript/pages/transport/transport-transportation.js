    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apitransport-transportation-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'transportation_type_id.transportation_type_name' },
                        { data: 'price' },
                        {
                            "data": null,
...
$(function () {
    ...
    $('#dt-table-list').on('click', 'button', function () {
        ...
        try {
            ...
            id = table_row['transportation_id']
        }
        catch (e) {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/transport-transportation-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
...
// Select 2
$('#id_transportation_type_id').select2({placeholder: "Select a class"})
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_transportation_type_id').val('').trigger('change')
            } else {
                $('#page_loading').modal('hide');

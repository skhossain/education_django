    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apitransport-locationinfo-api/";
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/transport-locationinfo-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
...
function get_upazila(id){
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            var district = $('#id_upazila_id')
            $('#id_upazila_id option').remove();
            district.append('<option value="">----------</option>')
            data.forEach(e => {

    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apitransport-driver-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        { data: 'driver_name' },
                        { data: 'contact_no' },
                        { data: 'dri_present_address' },
                        { data: 'dri_permanent_address' },
                        { data: 'license_no' },
                        {
                            "data": null,
...
function get_upazila(id){
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            var upozila = $('#id_pre_upozila_id')
            $('#id_pre_upozila_id option').remove();
            upozila.append('<option value="">----------</option>')
            data.forEach(e => {
                upozila.append('<option value="'+e.upozila_id+'">'+e.upozila_name+'</option>')
            });
        }
    })
}

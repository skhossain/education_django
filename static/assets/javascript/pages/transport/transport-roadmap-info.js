    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apitransport-roadmap-api/";
...
//     $('#id_transportation_type_id').change(function(){
//         filtering_trans()
//     })
    
//     function filtering_trans(){
//         var transportation_type_id=document.getElementById('id_transportation_type_id').value
    
//         $.ajax({
//             url: "apitransport-transportation-api/?transportation_type_id="+transportation_type_id,
//             type: 'get',
//             datatype: 'json',
//             success: function (data) {
//                 $("#id_transportation_id option").remove();
//                 data.forEach(element => {
//                     $("#id_transportation_id").append('<option value="'+element.transportation_id+'">'+element.transportation_name+'</option>');
//                 });
//                 // console.log(data)
//             }
//         })

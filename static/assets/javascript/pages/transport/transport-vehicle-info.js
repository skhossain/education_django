    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apitransport-vehicleinfo-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'vehicle_type_id.vehicle_type_name' },
                        { data: 'vehicle_name' },
                        { data: 'vehicle_number' },
                        { data: 'vehicle_image' }, 
                        { data: 'total_seat' },
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/transport-vehicleinfo-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
...
$('#id_vehicle_type_id').select2({placeholder: "Select a vehicle type name"})
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.form_is_valid) {
                ...
                $('#id_vehicle_type_id').val('').trigger('change')
            } else {
                $('#page_loading').modal('hide');
...
//     var transportation_name=document.getElementById('id_transportation_').value

//     $.ajax({
//         url: "apitransport-vehicletype-api/?transportation_name="+transportation_name+"&transportation_type_id="+transportation_type_id,
//         type: 'get',
//         datatype: 'json',
//         success: function (data) {
//             $("#id_vehicle_type_id option").remove();
//             data.forEach(element => {
//                 $("#id_vehicle_type_id").append('<option value="'+element.vehicle_type_id+'">'+element.vehicle_type_id+'</option>');
//             });
//             // console.log(data)
//         }
//     })

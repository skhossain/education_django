    ...
    function() {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const search_url = "/apiedu-submappTeacher-api/"
...
$(function() {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/edu-subteacherlist-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function() {
...
function get_subject_list() {
    var class_group = document.getElementById('id_class_group_id').value
    var class_id = document.getElementById('id_class_id').value
    $.ajax({
        url: "apiedu-sublist-api/?class_id=" + class_id,
        type: 'GET',
        dataType: 'json',
        success: function(data) {
            ...
            data.forEach(G => {
                $("#id_subject_id").append('<option value="' + G.subject_id + '">' + G.subject_name + '</option>');
            })
        }
    })
}
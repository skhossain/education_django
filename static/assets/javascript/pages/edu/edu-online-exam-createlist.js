                    ...
                    columns: [
                        ...
                        { data: 'total_marks' },
                        {
                            ...
                            "render": function(data, type, row, meta){
                                data = '<a class="btn btn-info" href="/edu-online-exam-question/'+data+'" target="_blank">Manage Question</a>\
                                <a href="/edu-online-question-preview/'+data+'" class="btn btn-primary">Question Preview</a>\
                                <a class="btn btn-info" href="/edu-online-exam-edit/'+data+'" target="_blank">Edit</a>';
                                return data;
                             }
                        }
                    ]
...
$(document).ready(function() {
    $('#exam_name').select2({placeholder: " Select a exam name "});
    $('#id_question_patten').select2();
    $('#id_publish_status').select2();
});
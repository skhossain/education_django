                    ...
                    columns: [
                        ...
                        { data: 'student_phone' },
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                data = '<a class="btn btn-info btn-sm" href="/edu-studentinfo-list-edit/' + data + '" target="_blank">Edit</a>  <button type="button" class="print btn btn-info btn-sm">print all info</button>  <button type="button" class="testi btn btn-info btn-sm d-none">Testimonial</button> <button type="button" class="tc btn btn-info btn-sm d-none">TC</button>';
                                return data;
                            }
                        }
                    ],
...
$(function() {
    ...
    $('#dt-table-list').on('click', 'button', function() {
        ...
        if (class_name == 'testi btn btn-info btn-sm') {
...
function print_testimonial(id) {
    $.ajax({
        url: 'edu-student-testimonial/' + id,
        datatype: 'json',
        beforeSend: function() {
            $('#edit_model').modal('show');
        },

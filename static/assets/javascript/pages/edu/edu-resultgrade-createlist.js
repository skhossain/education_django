    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                let grade_name = $('#id_grade_name').val()
                let id_result_gpa = $('#id_result_gpa').val()
                let id_out_of = $('#id_out_of').val()
                const search_url = "/apiedu-result-grade-api/?grade_name="+grade_name+"&result_gpa="+id_result_gpa+"&out_of="+id_out_of;

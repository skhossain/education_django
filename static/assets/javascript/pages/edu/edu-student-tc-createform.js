    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const search_url = "/apiedu-tc-api/";
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            "data": null,
                            "defaultContent": '<button type="button" class="btn btn-info btn-sm">View TC</button> <button type="button" class="edit btn btn-info btn-sm">Edit TC</button>'
                        }
                    ]
                });
            }
...
$(function () {
    ...
    $('#dt-table-list').on('click', 'button', function () {
        ...
        try {
            ...
            id = table_row['student_roll']['student_roll']
        }
        catch (e) {
        ...
        if (class_name == 'edit btn btn-info btn-sm') {
            show_edit_form(id);
        }
    })

    function show_viewtc_form(id) {
        console.log(id)
        $.ajax({
            url: '/edu-tc-viewform/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
...
// Select 2
$('#roll_list').select2({placeholder: "Select a student"})

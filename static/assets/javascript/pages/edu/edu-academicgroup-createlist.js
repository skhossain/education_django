    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const class_group_name = document.getElementById('id_class_group_name').value;
                const search_url = "/apiedu-academicgroup-api/?class_id="+class_id+"&class_group_name="+class_group_name;

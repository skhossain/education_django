    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const search_url = "/apiedu-sectioninfo-api/?class_id="+class_id;
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        }},
                        {
                            "data": 'section_id',
                            "render": function(data, type, row, meta){
                                data = '<a class="btn btn-info btn-sm" href="/edu-sectioninfo-edit/'+data+'" target="_blank">Edit</a>';
                                return data;
                             }
                            // "data": null,
...
function time_format(time){
    return moment(new Date (new Date().toDateString() + ' ' + time)).format('LT');
}
let id = 0

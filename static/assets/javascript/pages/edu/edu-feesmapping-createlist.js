    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                let head_code = $('#id_head_code').val()
                let class_id = $('#id_class_id').val()
                let class_group_id = $('#id_class_group_id').val()
                let section_id = $('#id_section_id').val()
                let effective_date = $('#id_effective_date').val()
                let fee_amount = $('#id_fee_amount').val()
                let fine_amount = $('#id_fine_amount').val()
                let pay_freq = $('#id_pay_freq').val()
                let academic_year = $('#id_academic_year').val()

                

                const search_url = "/apiedu-feesmapping-api/?head_code=" + head_code + "&class_id=" + class_id + "&class_group_id=" + class_group_id + "&section_id=" + section_id + "&effective_date=" + effective_date + "&fee_amount=" + fee_amount + "&fine_amount=" + fine_amount + "&pay_freq=" + pay_freq+ "&academic_year=" + academic_year ;

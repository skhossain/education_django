    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const search_url = "/apiedu-board-name-api/?branch_code=" + branch_code;
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.redirect_url) {
                ...
                window.open(protocol+'//'+host + '/' + data.redirect_url)
            }
             else {
                $('#page_loading').modal('hide');

    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                ...
                const category_id = document.getElementById('id_category_id').value;
                const subject_type_id = document.getElementById('id_subject_type_id').value;
                const subject_name = document.getElementById('id_subject_name').value;
                const search_url = "/apiedu-sublist-api/?class_id="+class_id+"&class_group_id="+class_group_id+"&category_id="+category_id+"&subject_type_id="+subject_type_id+"&subject_name="+subject_name;
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'subject_type_id.subject_type_name' },

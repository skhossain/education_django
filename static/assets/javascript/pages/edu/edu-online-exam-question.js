...
$('#btn-choices').click(
    function (){
        ...
        if(que_type=='MCQ'){
        var input_field='<div class="col-10"><label>Answer '+ans_count+'</label><input type="text" name="ans_'+ans_count+'" id="id_ans_'+ans_count+'" class="form-control"></div> \
        <div class="col-2"><br><br><input type="radio" name="right_ans" value="'+ans_count+'"></div>'
        }else if(que_type=='MCQS'){
            var input_field='<div class="col-10"><label>Answer '+ans_count+'</label><input type="text" name="ans_'+ans_count+'" id="id_ans_'+ans_count+'" class="form-control"></div> \
        <div class="col-2"><br><br><input type="checkbox" name="right_ans_'+ans_count+'" value="1"></div>'
        }
        $('#answer_input').append(input_field)
        $('#id_answer_count').val(ans_count)
    }
)
    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const bill_id = '';
                const search_url = "/apihrm-payBill-api?bill_id=" + bill_id;
...
$(document).ready(function() {
    $('#id_prepare_by').select2({placeholder: " Select a Employee "});
    $('#id_checked_by').select2({placeholder: " Select a Applicant "});
    $('#id_approve_by').select2({placeholder: " Select a Applicant "});
});

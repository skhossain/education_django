    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const emptype_id = '';
                const search_url = "/apihrm-employeeType-api?emptype_id=" + emptype_id;
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/hrm-employee-type-info-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
            ...
            if (data.form_is_valid) {
                ...
                if(data.success_message){
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
                        title: data.success_message+" "+data.emptype_id,

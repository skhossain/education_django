    ...
    function () {
        ...
        _createClass(fn_data_table, [{
            ...
            value: function table() {
                const id = '';
                const search_url = "/apihrm-empDocument-api?id=" + id;
                table_data = $('#dt-table-list').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'document_type.document_type_name' },
...
$(function () {
    ...
    function show_edit_form(id) {
        $.ajax({
            url: '/hrm-employee-document-edit/' + id,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
...
$('#btnAddRecord').click(function (e) {
    post_tran_table_data(e);
});

function post_tran_table_data(e) {
    e.preventDefault()
    const data_url = $("#tran_table_data").attr('data-url');

    // const data_string = $("#tran_table_data").serialize();
    var formData = new FormData(this);  
    formData.append('file',$('#id_document_location').get(0).files[0])
